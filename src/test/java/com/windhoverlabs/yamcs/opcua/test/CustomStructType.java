...
public class CustomStructType implements UaStructure {
  ...
  public static class Codec extends GenericDataTypeCodec<CustomStructType> {
    ...
    @Override
    public CustomStructType decode(SerializationContext context, UaDecoder decoder)
    ...
    @Override
    public void encode(SerializationContext context, UaEncoder encoder, CustomStructType value)
        throws UaSerializationException {
