 ...
 * @author lgomez
 */
public abstract class AbstractInvalidConfigOPCUAIntegrationTest {

  protected final String yamcsHost = "localhost";
  protected final int yamcsPort = 9190;
  protected final String yamcsInstance = "IntegrationTestInvalidConfigOCOUALink";
  ...
  protected void setupYamcs() throws Exception {
    Path dataDir =
        Path.of(
            ...
            "yamcs-IntegrationTestInvalidConfigOCOUALink-data");
    FileUtils.deleteRecursivelyIfExists(dataDir);

    YConfiguration.setupTest("IntegrationTestInvalidConfigOCOUALink");
