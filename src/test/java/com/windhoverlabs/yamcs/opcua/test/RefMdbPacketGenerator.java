...
/**
 * Based on Generates packets according to the refmdb database.
 *
...
public class RefMdbPacketGenerator extends AbstractService implements TmPacketProvider {
  ...
  public volatile long pIntegerPara1_11_1_unsigned_value =
      2952790014L; // the equivalent unsigned value
  ...
  public static final String pFixedStringPara1_3_1 = "Ab"; // 16 bits
  public static final String pFixedStringPara1_3_2 = "A"; // 8 bits
  public static final String pTerminatedStringPara1_3_3 = "Abcdef"; // Null terminated
  public static final String pTerminatedStringPara1_3_4 = "Abcdef"; // Comma terminated
  public static final String pPrependedSizeStringPara1_3_5 =
      "Abcdefghijklmnopqrstuvwxyz"; // First 16 bits (2 bytes)
  // set size in bits of size
  // tag
  public static final String pPrependedSizeStringPara1_3_6 =
      "Abcdef"; // First 8 bits (1 byte) set size in bits of
  // size tag
  public static final String pFixedStringPara1_3_7 = "Abcdefghijklmnop"; // 128 bits
  ...
  public String pStringFloatTSCPara1_4_2 =
      "0.0000001"; // Comma terminated, leading zeros and calibrated
  public static final String pStringFloatTSSCPara1_4_3 =
      "0.12"; // Semi-colon terminated, leading zero
  public static final String pStringFloatFSBPara1_4_4 = "1.34567890123456"; // 128 bit string
  public static final String pStringFloatPSPara1_4_5 =
      "1.345678"; // Prepended size string, first 8 bits (1 byte) set
  // size in bits of size tag

  // Get integers from strings
  public static final String pStringIntFixedPara1_5_1 = "120"; // Fixed size, 24 bits
  public String pStringIntTermPara1_5_2 = "12"; // Comma terminated
  public static final String pStringIntTermPara1_5_3 = "12045"; // Semi-colon terminated
  public static final String pStringIntPrePara1_5_4 = "1204507"; // Prepended size (16 bits)
  public static final String pStringIntStrPara1_5_5 = "123406789"; // string
  ...
  /** Generate a packet with configurable content */
  public byte[] generate_PKT1_6(
      int pIntegerPara16_1, int pIntegerPara16_2, long rectime, long gentime) {
  ...
  public byte[] generate_PKT1_10(
      int pIntegerPara1_10_1, int pEnumerationPara1_10_2, float pFloatPara1_10_3) {
  ...
  /**
   * set the generation time used to send the packets. If TimeEncoding.INVALID_INSTANT is used, the
   * current time will be sent
   *
   * @param genTime
   */
  ...
  private void fill_PKT1_10(
      ByteBuffer bb, int pIntegerPara1_10_1, int pEnumerationPara1_10_2, float pFloatPara1_10_3) {
    fill_PKT1(bb, 10);
    int offset = pkt1Length;
    bb.position(offset);
  ...
  private void putPrependedSizeStringParam(ByteBuffer bb, String value, int tagSizeInBits) {
    ...
    System.arraycopy(value.getBytes(), 0, ba, 0, value.getBytes().length);
    bb.put(ba);
    // System.out.println( String.format("- put PrependedSizeString '%s' with leading %d bits filled
    // with number %d
